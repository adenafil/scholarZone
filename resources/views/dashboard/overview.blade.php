...
<body class="app">
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><img style class="logo-icon me-2" src="/dashboard-template/assets/images/portal-logo-ade.svg" alt="logo"><span class="logo-text">PORTAL</span></a>
    ...
    <img  src="/dashboard-template/assets/images/application.svg" alt="Icon" class=" bi bi-house-door" id="navIcon"  data-hover="/dashboard-template/assets/images/application-hover.svg"
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
	  ...
	  <path fill-rule="evenodd" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/>
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="help.blade.php">
						        <span class="nav-icon">
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
    ...
    <script>
        // Pilih elemen img berdasarkan id
        const navIcon = document.querySelector('#navIcon');

        // Saat mouse memasuki elemen (hover)
        navIcon.addEventListener('mouseenter', function () {
            this.src = this.getAttribute('data-hover'); // Ganti gambar dengan data-hover saat hover
            console.log('Hover masuk');
        });

        // Saat mouse keluar dari elemen (mouseleave)
        navIcon.addEventListener('mouseleave', function () {
            // Jika gambar tidak aktif, kembali ke gambar default
            if (!this.classList.contains('active')) {
                this.src = '/dashboard-template/assets/images/application.svg';
            }
            console.log('Hover keluar');
        });

        // Saat klik
        navIcon.addEventListener('click', function () {
            // Toggle class active saat klik
            this.classList.toggle('active');

            // Ganti gambar dengan data-active saat klik
            if (this.classList.contains('active')) {
                this.src = this.getAttribute('data-active');
            } else {
                this.src = this.getAttribute('data-hover'); // Kembali ke hover jika tidak aktif
            }
            console.log('Gambar di klik');
        });
